...
data <- data %>%
 ...
 graph4 <- data %>%
   ggplot() +
  aes(x = number_of_commercial_bank_branches_per_100_000_adults , y = outstanding_deposits_with_commercial_banks_percent_of_gdp, color = economy, shape = region) +   geom_point(size = 2) +
  theme_minimal() +
