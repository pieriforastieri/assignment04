...
data2 <- data %>%
  mutate(
    region = case_when(
      economy == "Argentina" | economy == "Bolivia" | economy == "Brazil" | economy == "Chile"| economy == "Columbia" ~ "Caribbean",
      economy == 2 ~ "South America",
      economy == 3 ~ "North America",
      economy == 4 ~ "Central America",
    )
