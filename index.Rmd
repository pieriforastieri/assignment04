...
graph1 <- data %>%
  ...
  labs(
    title = "Number of ATMs and Commercial Bank Branches in Latin American Countries",
    subtitle = "(per 100,000 adults)",
    caption = "Source: IMF Financial Access Survey (FAS)",
    y = "Number of ATMs and Commercial Bank Branches"
  ) +
  theme_minimal()
graph1 + theme(legend.title = element_blank(), axis.title.x = element_blank())
```
